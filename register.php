...
<ul class="nav nav-pills nav-justified">
  			...
  			<li role="presentation" class="active" ><a href="register.php"><span style="font-family: 'Bungee Shade', cursive;font-size: 25;">Register</span></a></li>
...
<div class="col-lg-5 col-md-7 col-sm-9 col-xs-12 ">
                        <form name="start" method="post" action="update.php" id="myform">
